...
const DashboardLayout = ({ children, activeRoute, onRouteChange }: DashboardLayoutProps) => {
  ...
  const menuItems = [
    ...
    { id: "website-auditor", label: "Website Auditor", icon: ClipboardCheck },
        ...
        {menuItems.map((item) => {
          ...
          return (
            <button
              ...
              className={cn(
                "w-full flex items-start gap-3 px-3 py-2.5 rounded-lg transition-all duration-150 text-sm text-left",
                isActive
